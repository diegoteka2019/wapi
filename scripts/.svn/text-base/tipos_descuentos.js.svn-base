1//TITULOS
titulos =  new Array('Tipos de Descuento');
//DMLs
var dmlBuscarMaster = '11104';
var dmlnuevoM = '11101';
var dmleditarM = '';
var dmlbuscarUnicoM = ''; 
var dmleliminarM = '11103';
var dmlAuditoriaMaster = '11106';
var dmlgrabarM = '';
//COLUMNAS
var columnasM = new Array('canal_venta','tipo_descuento_id','descripcion');
var tiposM = new Array('text','text','text');
//DESCRIPCIONES
var descripcionesM = new Array('Canal de Venta','C&oacute;digo','Descripci&oacute;n');
//PRIMARY KEY
var clavesM = new Array('tipo_descuento_id','cod_canal_venta');
//FILTROS
...
//FORMULARIO
var camposFormM = new Array('cod_canal_venta','tipo_descuento_id');
var labelFormM = new Array('Canal de Venta','C&oacute;digo: ');
var requeridoFormM = new Array(true,true);
var regexpFormM = new Array('.*','.*');
var mensajesFormM = new Array('Seleccione el Canal de Venta','Seleccione el Tipo de Descuento');
var dojoTypeFormM = new Array('FilteringSelect','FilteringSelect');
var searchAttrFormM = new Array('detalle','detalle');
var selectFormM = new Array('11108','11107');
...
function NuevoMaster(){
	...
	//dijit.byId('credito').attr('checked',true);
...
function EliminarMaster(){
	...
	mensaje='Est&aacute; seguro que desea eliminar el Tipo de Descuento <b>'+items[0][columnasM[1]]+' - '+items[0][columnasM[2]]+'</b><br>para el Canal <b>'+items[0][columnasM[0]]+'?';
...
function GrabarMaster(){
	...
	for(i=0;i<camposFormM.length;i++){
		if(!(dojoTypeFormM[i]=='RadioButton')){
