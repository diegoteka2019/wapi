//TITULOS
var titulos =  new Array("Descripciones Propuestas");
//DMLs
var dmlBuscarMaster = "10304";
var dmlnuevoM = "10301";
var dmleditarM = "10302";
var dmlbuscarUnicoM = "10305"; 
var dmleliminarM = "10303";
var dmlAuditoriaMaster = "10306";
var dmlgrabarM = "";
//COLUMNAS
var columnasM = new Array("descripcion_propuesta_id",'division',"descripcion",'estado');
...
//PRIMARY KEY
var clavesM = new Array("descripcion_propuesta_id");
//FILTROS
...
//FORMULARIO
var camposFormM = new Array('descripcion_propuesta_id','descripcion','division_id','estado');
...
var selectFormM = new Array('','','10307','');
...
function NuevoMaster(){
	...
	dijit.byId('descripcion_propuesta_id').attr('disabled',true);
	dijit.byId('descripcion_propuesta_id').attr('required',false);
...
function EliminarMaster(){
	...
	mensaje='Est&aacute; seguro que desea eliminar la descripci&oacute;n propuesta <b>'+items[0][columnasM[1]]+'</b><br> perteneciente a la divisi&oacute;n '+items[0][columnasM[2]]+'?';
