//TITULOS
var titulos =  new Array('Depuraci&oacute;n de Adjuntos');
//DMLs
var dmlBuscarMaster = '';
var dmlnuevoM = '';
var dmleditarM = '';
...
var dmlgrabarM = '';
var dmldepurarM = '12901'
//COLUMNAS
var columnasM = new Array('tabla','cant_depurar','peso','habilitada');
var descripcionesM = new Array('Tablas a Depurar','Cantidad de Registros a Depurar','Peso en MB','<input type="checkbox" id="selected" title="Seleccionar Todos" name="selected" onclick="CheckColumn(this);"/> Seleccionar');
...
function BuscarMaster(){
	var urlValue ='dbi/depuracion_adjuntos_stats.php?sid='+gvarSID;
	if(dijit.byId('filtrMaster')){
