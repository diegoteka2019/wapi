//TITULOS
var titulos =  new Array('Tipificaci&oacute;n Presupuestos');
//DMLs
var dmlBuscarMaster = '11204';
var dmlnuevoM = '11201';
var dmleditarM = '';
var dmlbuscarUnicoM = ''; 
var dmleliminarM = '11203';
var dmlAuditoriaMaster = '11206';
var dmlgrabarM = '';
//COLUMNAS
var columnasM = new Array('tipo_presupuesto_id','tipo_descuento_id','descripcion','tipo_descuento_desc','flag_provision','flag_esventa','flag_esmkt');
var tiposM = new Array('text','text','text','text','text');
//DESCRIPCIONES
var descripcionesM = new Array('Presupuesto ID','Descuento ID','Presupuesto','Tipo Descuento','Tipificaci&oacute;n determinada','Es Venta','Es Mkt');
//PRIMARY KEY
var clavesM = new Array('tipo_presupuesto_id','tipo_descuento_id');
//FILTROS
...
//FORMULARIO
var camposFormM = new Array('tipo_presupuesto_id','tipo_descuento_id','flag_provision','flag_esventa','flag_esmkt');
var labelFormM = new Array('Tipo: ','C&oacute;digo: ','Tipificaci&oacute;n Determinada (Provisi&oacute;n): ','Es Venta: ','Es Mkt: ');
var requeridoFormM = new Array(true,true,false,false,false);
var regexpFormM = new Array('.*','.*','.*','.*','.*');
var mensajesFormM = new Array('Ingrese el tipo de presupuesto','Ingrese el tipo de descuento','','','');
var dojoTypeFormM = new Array('FilteringSelect','FilteringSelect','CheckBox','CheckBox','CheckBox');
var searchAttrFormM = new Array('detalle','detalle','','','');
var selectFormM = new Array('11207','11208','','','');
...
var layoutMaster = [
	...
	{width: '125px', field: columnasM[4], name: descripcionesM[4], formatter: formatCheckbox, styles:'text-align:center;'},
	{width: '60px', field: columnasM[5], name: descripcionesM[5], formatter: formatCheckbox, styles:'text-align:center;'},
	{width: '60px', field: columnasM[6], name: descripcionesM[6], formatter: formatCheckbox, styles:'text-align:center;'}];
//campos de auditoria
...
function NuevoMaster(){
	...
	dijit.byId(camposFormM[3]).onClick = function(){dijit.hideTooltip(dijit.byId(camposFormM[3]).domNode);}
	dijit.byId(camposFormM[4]).onClick = function(){dijit.hideTooltip(dijit.byId(camposFormM[3]).domNode);}
...
function GrabarMaster(){
	...
	if(dijit.byId(camposFormM[3]).attr('checked')==true && dijit.byId(camposFormM[4]).attr('checked')==true){dijit.showTooltip('No se pueden  seleccionar ambos Checkbox Es Venta , Es MKT elija uno',dijit.byId(camposFormM[3]).domNode,'above');return;}
