//TITULOS
var titulos =  new Array("Objetivos de Ventas");
//DMLs
var dmlBuscarMaster = "10504";
var dmlnuevoM = "10501";
var dmleditarM = "10502";
var dmlbuscarUnicoM = "10505"; 
var dmleliminarM = "10503";
var dmlAuditoriaMaster = "10506";
var dmlgrabarM = "";
//COLUMNAS
var columnasM = new Array("objetivo_propuesta_id",'division',"descripcion",'estado');
...
//PRIMARY KEY
var clavesM = new Array("objetivo_propuesta_id");
//FILTROS
...
//FORMULARIO
var camposFormM = new Array('objetivo_propuesta_id','descripcion','division_id','estado');
...
var mensajesFormM = new Array('Ingrese el c&oacutedigo','Ingrese la descripci&oacute;n','Seleccione la divisi&oacute;n');
...
var selectFormM = new Array('','','10507','');
...
function NuevoMaster(){
	...
	dijit.byId('objetivo_propuesta_id').attr('disabled',true);
	dijit.byId('objetivo_propuesta_id').attr('required',false);
...
function EliminarMaster(){
	...
	mensaje='Est&aacute; seguro que desea eliminar el objetivo de venta <b>'+items[0][columnasM[1]]+'</b><br> perteneciente a la divisi&oacute;n '+items[0][columnasM[2]];
...
function GrabarMaster(){
	...
	dojo.xhrPost({url:urlValue,handleAs:'json',sync:'true',load:function(response){
		...
		dijit.byId('dialogMaster').show();PopUp('Error', response.errmsg);}
	}});
}
////////////////////////////////////////////////////////////////////////////////////////////////////
