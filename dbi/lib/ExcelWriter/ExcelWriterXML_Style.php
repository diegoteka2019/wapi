...
class ExcelWriterXML_Style {
	...
	function getStyleXML(){
		...
		if (empty($this->id)) return '';//if (empty($this->id)) throw new exception;
     ...
     */
	function numberFormatDate(){$this->numberFormat('mm/dd/yy');}

	/**
     * Sets a default time format for a style
     */
	function numberFormatTime(){$this->numberFormat('hh:mm:ss');}

	/**
     * Sets a default date and time format for a style
     */
	function numberFormatDatetime(){$this->numberFormat('mm/dd/yy\ hh:mm:ss');}
	//////////////////////////
}
?>