			...
			if ( $errors['errcode'] == "" ) {  		
				...
				if (($dmls['dmlPropuestas'] == "")||($dmls['dmlMarcasPropuestas'] == "")) {
					...
					if ( $errors['errcode'] == "" ) {
						...
						$varSalida = "identifier:\"marca_id\",";
						$varSalida = $varSalida . "label:\"marca_id\",";
						...
						while ($result = $con->getArrayResultadoQuery($stmt)) {
                            ...
                            $varSalida = $varSalida . '{"marca_id":"' . $result['MARCA_ID'] . '","marca_desc":"' . $result['MARCA_DESC'] . '"}';
						}
