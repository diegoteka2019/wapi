<?php
   ...
   /************************************************* 
    ...
    Obtiene el adjunto de un comprobante SP
		plan_especial_id:	Identificador del comprobante

	20/07/2010	Esteban Lopez	Creacion version inicial
    *************************************************/
	...
	$dmlidBuscarAdjunto = '12728';
	$cbteId = $_POST['plan_especial_id'] . $_GET['plan_especial_id'];
	//Interfaz PHP-DBI
	$result = null;
	$con = null;
	$stmt = null;
